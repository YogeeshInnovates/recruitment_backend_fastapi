...
GROQ_TRANSCRIBE_MODEL = os.getenv(GROQ_MODEL_ENV, "whisper-large-v3")
...
def transcribe_audio(file_bytes: bytes, filename: str = "recording.webm",
    ...
    return {"transcript": "", "error": f"transcription_failed: {last_error}"}